...
# --- KUNCI RAHASIA VERSI PALING AMAN ---
# Menggunakan triple quotes (r""") agar HP tidak merusak formatnya
KUNCI_PRIVATE = r"""-----BEGIN PRIVATE KEY-----
...
def init_connection():
    ...
    # Langsung menggunakan INFO_KUNCI yang sudah kita buat r"""
    creds = Credentials.from_service_account_info(INFO_KUNCI, scopes=scope)
    client = gspread.authorize(creds)
    # Pastikan Nama file di Google Sheets sudah sesuai
